                    ...
                    {ignoredLeagues.length === 0 ? (
                      ...
                      ignoredLeagues.map((league) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span
                              className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(league.status)}`}
                            >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span
                              className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${getPriorityColor(league.priority)}`}
                            >
                              {getPriorityIcon(league.priority)}
                              <span className="ml-1">
                                {league.priority.toUpperCase()}
                              </span>
                            </span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
