...
const mockWebhookEvents: WebhookEvent[] = [
  {
    ...
    event: "pull_request",
    action: "opened",
    repositoryOwner: "guibranco",
    repositoryName: "projects-monitor",
    sender: "john-doe",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    event: "pull_request",
    action: "closed",
    repositoryOwner: "sveltejs",
    repositoryName: "svelte",
    sender: "david-miller",
  },
  {
    id: "9",
...
const mockInstallationRepositories: InstallationRepository[] = [
  ...
  },
  {
    ...
    date: "2024-01-10 09:30:00",
    repositoryOwner: "guibranco",
    repositoryName: "gstraccini-bot",
    visibility: "public",
    lastAction: "issue_labeled",
    lastActionDate: "2024-01-15 13:45:00",
  },
  {
    id: "3",
    date: "2024-01-08 15:45:00",
  ...
  },
  {
    ...
    repositoryName: "typescript",
    visibility: "public",
    lastAction: "pull_request_reviewed",
    lastActionDate: "2024-01-15 12:30:00",
  },
  {
    id: "5",
    date: "2024-01-05 11:20:00",
  ...
  },
  {
    ...
    visibility: "public",
    lastAction: "pull_request_synchronized",
    lastActionDate: "2024-01-15 11:50:00",
  },
  {
    id: "7",
    date: "2024-01-03 14:10:00",
  ...
  },
  {
    ...
    repositoryName: "swr",
    visibility: "public",
    lastAction: "issue_commented",
    lastActionDate: "2024-01-15 10:20:00",
  },
  {
    id: "9",
    date: "2024-01-01 10:00:00",
  ...
  },
  {
    ...
    date: "2024-01-01 10:00:00",
    repositoryOwner: "nodejs",
    repositoryName: "undici",
    visibility: "public",
    lastAction: "pull_request_opened",
    lastActionDate: "2024-01-15 09:15:00",
  },
  {
    id: "11",
    ...
    visibility: "public",
    lastAction: "issue_labeled",
    lastActionDate: "2024-01-15 08:30:00",
  },
  {
    id: "12",
    ...
    visibility: "public",
    lastAction: "pull_request_reviewed",
    lastActionDate: "2024-01-14 18:45:00",
  },
  {
    id: "13",
    ...
    repositoryName: "svelte",
    visibility: "public",
    lastAction: "comment_edited",
    lastActionDate: "2024-01-14 16:20:00",
  },
  {
    id: "14",
    date: "2023-12-15 10:45:00",
    repositoryOwner: "tailwindlabs",
    repositoryName: "tailwindcss",
    visibility: "public",
    lastAction: "issue_reopened",
    lastActionDate: "2024-01-14 14:10:00",
  },
  {
    id: "15",
    date: "2023-12-10 13:20:00",
    repositoryOwner: "vitejs",
    repositoryName: "vite",
    visibility: "public",
    lastAction: "pull_request_closed",
    lastActionDate: "2024-01-14 12:30:00",
  },
];
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.pullRequests.lastHour}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.pullRequests.last6Hours}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.pullRequests.lastDay}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.pullRequests.last7Days}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.pullRequests.lastMonth}
                      </span>
                    </div>
                    <div className="border-t border-gray-200 dark:border-gray-600 pt-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-xl font-bold text-green-600 dark:text-green-400">
                          {mockProcessingStats.pullRequests.total.toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.issues.lastHour}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.issues.last6Hours}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.issues.lastDay}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.issues.last7Days}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.issues.lastMonth}
                      </span>
                    </div>
                    <div className="border-t border-gray-200 dark:border-gray-600 pt-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-xl font-bold text-red-600 dark:text-red-400">
                          {mockProcessingStats.issues.total.toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.comments.lastHour}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.comments.last6Hours}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.comments.lastDay}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.comments.last7Days}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-white">
                        {mockProcessingStats.comments.lastMonth}
                      </span>
                    </div>
                    <div className="border-t border-gray-200 dark:border-gray-600 pt-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-xl font-bold text-blue-600 dark:text-blue-400">
                          {mockProcessingStats.comments.total.toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                        {mockProcessingStats.totalRepositories}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
                        {mockProcessingStats.totalInstallations}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                        {mockProcessingStats.totalWebhooksProcessed.toLocaleString()}
                      </p>
                    </div>
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {mockWebhookEvents.map((event) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getActionColor(event.action)}`}
                          >
                            {event.action}
                          </span>
                        </td>
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {mockInstallations.map((installation) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getRepositorySelectionColor(installation.repositorySelection)}`}
                          >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-wrap gap-1">
                            {installation.usersAssociated.map((user, index) => (
                              <span
                                key={index}
                                className="inline-flex items-center px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400"
                              >
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {mockInstallationRepositories.map((repo) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${getVisibilityColor(repo.visibility)}`}
                          >
